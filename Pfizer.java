...
/**
 *Klasa obsługująca okno wyświetlające informacje o szczepionce Pfizer
 * 
 * @author aleks
 */
public class Pfizer implements ActionListener, WindowListener{
    ...
    /**
     * Konstruktor klasy Pfizer
     * Tworzy graficzna stronę okna.
     * Informacje o szczepionce pobiera z odpowiedniego pliku.txt.
     */
    Pfizer() {
        ...
        frame.setTitle("Informacje o szczepionce Pfizer");
        frame.setResizable(false);
        frame.getContentPane().setBackground(new Color (223, 198, 249));
     ...
     /**
      * Metoda osbługująca interakcje użytkownika z programem na poziomie okna Pfizer.
      * 
