...
/**
 * Klasa obsługująca okno wyświetlające informacje o szczepionce Moderna
 * 
 * @author aleks
 */
public class Moderna implements ActionListener, WindowListener {
    ...
    /**
     * Konstruktor klasy Moderna
     * Tworzy graficzna stronę okna.
     * Informacje o szczepionce pobierane są z odpowiedniegi pliku.txt.
     * 
     * @throws IOException obsługuje wyjątek operacji wejścia
     */
    Moderna() throws IOException {
        ...
        frame.setTitle("Informacje o szczepionce Moderna");
        frame.setResizable(false);
        frame.getContentPane().setBackground(new Color (213, 243, 184));
    ...
    /**
     * Metoda obsługująca interakcje użytkownika z programem na poziomie okna Moderna
     * 
